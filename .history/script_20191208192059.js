window.onload = function()  
{
    ...
    var blockSize = 30;
    var ctx;
    var delay = 150;   // si j'augmente le délai de rafraichissement du canvas,  le serpent avance moins vite, comme ça il se rafraichit une fois toutes les secondes et non toutes les dixièmes de secondes
    var snakee;
    var applee;
    ...
    function gameOver()  //Je souhaite que cette fonction écrive GameOver à chaque fois que le serpent rencontre un mur ou lui-même
    {
        ctx.save();   //permet d'enregistrer les paramètre de configuration du contexte du combat cad de le retrouver comme avant
        ...
        ctx.strokeText("Game Over", centreX, centreY -180);  //pour le stroke -180 cad un petit peu au-dessus du 0
        ctx.fillText("Game Over", centreX, centreY -180);
        ctx.font = "bold 30px sans-serif";
        ctx.strokeText("Appuyer sur la touche Espace pour rejouer", 5, 30);
    ...
    function drawScore()   //fonction qui permet d'afficher le score à l'écran
    {
        ctx.save();
        ...
        var centreX = canvasWidth / 2;
        var centreY = canvasHeight / 2;    
        ctx.fillText(score.toString(), centreX, centreY);    //ctx.fillText(score.toString(), 5, canvasHeight - 5);
        ctx.restore();
    }
    ...
    document.onkeydown = function handleKeyDown(e)   //évènement
    {
        ...
        switch(key)             //swith sur la touche appuyée
        {
            ...
            case 40:    //flèche qui va en bas
                newDirection = "down";
                break;
            case 32:  //code de la touche Espace
                restart();
                return;
            default:
                return;                  
