window.onload = function()  
{
    ...
    function Snake(body, direction)
    {
        ...
        this.checkCollision = function()   //Fonction pour délimiter l'espace du serpent ==> pour ne pas qu'il sorte du canvas sinon game over 
        {
            ...
            {
                if(snakeX === rest[i][0] && )  //je vérifie si la tête du serpent est sur l'élément 0 ==>[i] et son X à lui [0] et je vérifie si la tête snakeX et l"élément du corps rest[i][0]
            }
