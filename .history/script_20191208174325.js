window.onload = function()  
{
    ...
    function Snake(body, direction)
    {
        ...
        this.advance = function()
        {
            ...
            this.body.pop();  // Le serpent a mangé un fruit. Ici le pop me permets d'enlever le dernier bloc cad on avançait la tête d'une position et on supprimait la dernière
        };
