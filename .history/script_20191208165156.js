window.onload = function()  
{
    ...
    var blockSize = 30;
    var ctx;
    var delay = 1000;   // j'augmente le délai de rafraichissement du canvas pour que le serpent avance moins vite? comme ça il se rafraichit une fois toutes les secondes et non toutes les dixièmes de secondes
    var snakee;
    var applee;
