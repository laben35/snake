window.onload = function()  
{
    ...
    var blockSize = 30;
    var ctx;
    var delay = 100;   // si j'augmente le délai de rafraichissement du canvas,  le serpent avance moins vite, comme ça il se rafraichit une fois toutes les secondes et non toutes les dixièmes de secondes
    var snakee;
    var applee;
    ...
    function refreshCanvas()
    {
        ...
        else
        {
            ...
            {
                //Le serpent a mangé un fruit donc on va replacer le fruit à un autre endroit d'où la nouvelle méthode: setNewPosition()
            }                                     // Condition est-ce que le serpent a mangé un fruit
    ...
    function Apple(position)
    {
        ...
        {
            var newx = (Math.random() * (widthInBlocks - 1));
            var newY = (Math.random() * (widthInBlocks - 1));
        };
    }
