window.onload = function()  
{
    ...
    var snakee;
    var applee;
    var widthInBlocks = canvasWidth/blockSize;  //la largeur en terme de block sera la largeur divisée par la taille du bloc c'est à dire, la largeur est de 900px et la taille du bloc est de 30px
    var 
