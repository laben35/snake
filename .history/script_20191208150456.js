window.onload = function()  
{
    ...
    function Snake(body, direction)
    {
        ...
        this.checkCollision = function()   //Fonction pour délimiter l'espace du serpent ==> pour ne pas qu'il sorte du canvas sinon game over 
        {
            ...
            var rest = this.body.slice(1);      //rest du corps du serpent en utilisant la fonction slice et autant qu'il passe sur la valeur 0 et va nous copier tout le reste dans ces règles. 
        }     
    }
